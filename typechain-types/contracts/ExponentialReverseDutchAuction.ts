...
export interface ExponentialReverseDutchAuctionInterface extends Interface {
  getFunction(
    nameOrSignature:
      | "auctionCounter"
      | "auctions"
...
export interface ExponentialReverseDutchAuction extends BaseContract {
  connect(runner?: ContractRunner | null): ExponentialReverseDutchAuction;
  waitForDeployment(): Promise<this>;

  interface: ExponentialReverseDutchAuctionInterface;

...
export interface AllPayAuctionInterface extends Interface {
  getFunction(
    nameOrSignature:
      | "auctionCounter"
      | "auctions"
...
export interface AllPayAuction extends BaseContract {
  connect(runner?: ContractRunner | null): AllPayAuction;
  waitForDeployment(): Promise<this>;

  interface: AllPayAuctionInterface;

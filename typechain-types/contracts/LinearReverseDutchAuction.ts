...
export interface LinearReverseDutchAuctionInterface extends Interface {
  getFunction(
    nameOrSignature:
      | "auctionCounter"
      | "auctions"
...
export interface LinearReverseDutchAuction extends BaseContract {
  connect(runner?: ContractRunner | null): LinearReverseDutchAuction;
  waitForDeployment(): Promise<this>;

  interface: LinearReverseDutchAuctionInterface;
  ...
  filters: {
    "AuctionCreated(uint256,string,string,string,address,uint8,address,uint256,address,uint256,uint256,uint256)": TypedContractEvent<
      AuctionCreatedEvent.InputTuple,
      AuctionCreatedEvent.OutputTuple,
      AuctionCreatedEvent.OutputObject
    >;

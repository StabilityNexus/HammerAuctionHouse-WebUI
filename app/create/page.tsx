...
/**
 * Converts unified auction form data into strongly typed parameter objects for the specified auction type.
 *
 * Maps user-provided form fields to the appropriate parameter structure required for each supported auction type, including English, AllPay, Linear Dutch, Exponential Dutch, Logarithmic Dutch, and Vickrey auctions. Handles duration calculations, bid amount parsing, and scaling of decay factors as needed. Throws an error if the auction type is not supported.
 *
 * @param formData - The raw form data collected from the auction creation UI.
 * @param auctionType - The type of auction to generate parameters for.
 * @returns The parameter object formatted for the specified auction type.
 * @throws Error if an unsupported auction type is provided.
 */
...
/**
 * React component for creating a new auction through a multi-step form with blockchain integration.
 *
 * Guides the user through entering auction details, settings, token information, and review before submitting the auction to the blockchain. Handles wallet connection, transaction submission, confirmation, and post-creation redirection. Supports multiple auction types and manages form state, navigation, and submission status.
 */

...
export default function AuctionsPage() {
  ...
  const filteredAuctions = mockAuctions.filter(auction => {
    ...
    const matchesType = selectedTypes.length === 0 || selectedTypes.includes(auction.type);
    
    const matchesStatus = selectedStatus.length === 0 || selectedStatus.includes(auction.status);

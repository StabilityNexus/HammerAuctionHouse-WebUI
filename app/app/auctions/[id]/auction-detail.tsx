      ...
      <div className="grid grid-cols-1 lg:grid-cols-2 gap-8">
        ...
        <div className="flex flex-col">
          ...
          >
            ...
            <div className="absolute bottom-4 right-4">
              <Badge status={currentAuction.status} type={currentAuction.type} />
            </div>
          </motion.div>
        ...
        >
          ...
          <p className="text-muted-foreground mt-2 mb-4">
            Created by{" "}
            {`${currentAuction.creator.substring(
              0,
              6
            )}...${currentAuction.creator.substring(38)}`}
          </p>
          ...
          <div className="bg-card border rounded-lg p-6 mb-6">
            <div className="flex justify-between mb-4">
              <div>
                ...
                <p className="text-3xl font-bold">
                  {currentAuction.currentPrice} ETH
                </p>
              </div>
            ...
            {currentAuction.status === "upcoming" && (
              <div className="bg-blue-500/10 text-blue-500 p-4 rounded-lg flex items-start">
                ...
                <p>
                  This auction hasn't started yet. Come back when it begins, or
                  add it to your watchlist to receive notifications.
                </p>
              </div>
            )}

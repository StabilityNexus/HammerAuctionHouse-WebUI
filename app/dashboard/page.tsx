...
/**
 * Renders the user dashboard for the auction platform, displaying created auctions, active bids, and watchlist items in separate tabs.
 *
 * Shows a wallet connection prompt if the user is not connected. When connected, fetches and displays auction data relevant to the user, allowing navigation between created auctions, auctions with active bids, and watched auctions.
 */

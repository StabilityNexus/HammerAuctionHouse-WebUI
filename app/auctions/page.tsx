...
/**
 * React component that displays a browsable and filterable grid of live auctions from multiple blockchain auction protocols.
 *
 * Fetches auction data for All-Pay, English, Linear Dutch, Exponential Dutch, Logarithmic Dutch, and Vickrey protocols using a blockchain client. Supports filtering by search query, auction type, and auction status ("active" or "ended"). Shows a loading indicator while fetching data and renders the filtered auction grid when ready.
 *
 * @returns The rendered auctions page component.
 */

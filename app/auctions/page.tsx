...
export default function AuctionsPage() {
  ...
  const fetchLinearDutchAuctions = async () => {
    ...
    try {
      ...
      const auctions = await linearDutchService.getLastNAuctions(publicClient, 50);
      return auctions;
    } catch (error) {
  ...
  const fetchExponentialDutchAuctions = async () => {
    ...
    try {
      ...
      const auctions = await exponentialDutchService.getLastNAuctions(publicClient, 50);
      return auctions;
    } catch (error) {
  ...
  const fetchLogarithmicDutchAuctions = async () => {
    ...
    try {
      ...
      const auctions = await logarithmicDutchService.getLastNAuctions(publicClient, 50);
      return auctions;
    } catch (error) {

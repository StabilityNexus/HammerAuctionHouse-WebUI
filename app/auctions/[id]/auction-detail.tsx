...
/**
 * Displays detailed information and interactive controls for a specific auction, dynamically fetching auction data from the blockchain based on protocol type and auction ID.
 *
 * Renders protocol-specific auction details, handles user actions for withdrawing funds or items, and conditionally displays UI elements based on auction state and user role. Integrates with blockchain clients and manages loading and error states.
 */
...
/**
 * Displays a status badge with color coding based on auction status and type.
 *
 * The badge shows the capitalized status and auction type, with background and text color reflecting the status.
 *
 * @param status - The current status of the auction (e.g., "active", "ended")
 * @param type - The type of the auction protocol
 */

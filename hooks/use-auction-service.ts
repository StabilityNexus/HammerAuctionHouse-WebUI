...
/**
 * React hook for interacting with an auction service based on the specified auction type.
 *
 * Provides loading and error state management, and exposes functions to fetch bid history, a single auction, or all auctions within a recent block range.
 *
 * @param auctionType - The type of auction to interact with
 * @returns An object containing the auction service instance, loading and error states, and asynchronous fetch functions for bid history, a single auction, and all auctions
 */

...
/**
 * Displays detailed information and interactive controls for a Vickrey auction, including its current phase, bid submission, bid history, and auction details.
 *
 * Renders the auction's name, auctioneer, asset amount, current phase with countdown, and phase-specific UI such as the bid form or winning bid summary. Fetches and displays bid history and bid variation charts after the commit phase. Provides tabbed navigation for auction details and bid history.
 *
 * @param currentAuction - The auction object containing all relevant auction data.
 * @param publicClient - The blockchain client used to fetch bid history and block information.
 */
